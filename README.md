...
[MIT](LICENSE) — используйте, форкайте и меняйте свободно, но копия
уведомления об авторстве и текста лицензии обязана оставаться во всех
копиях и форках. Программа предоставляется «как есть», без каких-либо
гарантий со стороны автора.
